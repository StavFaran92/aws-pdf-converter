...
public class Manager {
    ...
    final private static String JAR_NAME = "worker.jar";
    final private static String KEYPAIR_NAME = /*"testKey"*/ "oshrir";

    //received from the first bgu.dsps.local app (will be a macro in bgu.dsps.local app)
    ...
    // to delete - only for bgu.dsps.local tests
    ...
    public static void main(String[] args) throws Exception {
        ...
        // create new sqs (bgu.dsps.manager->workers and workers->bgu.dsps.manager)
